...
namespace EzySlice
{
    ...
    {
        private readonly float posStartX;
        private readonly float posStartY;
        private readonly float posEndX;
        private readonly float posEndY;
        ...
        public float startX => posStartX;

        public float startY => posStartY;

        public float endX => posEndX;

        public float endY => posEndY;
        ...
        {
            float mappedX = MAP(x, 0.0f, 1.0f, posStartX, posEndX);
            float mappedY = MAP(y, 0.0f, 1.0f, posStartY, posEndY);
