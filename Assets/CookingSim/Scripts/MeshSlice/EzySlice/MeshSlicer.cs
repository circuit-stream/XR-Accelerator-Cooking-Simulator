    ...
    public static class MeshSlicer
    {
        ...
        private class SlicedSubmesh
        {
            ...
            public bool HasNormal =>
                // what is this abomination??
                UpperHull.Count > 0 ? UpperHull[0].hasNormal :
                    LowerHull.Count > 0 && LowerHull[0].hasNormal;
            ...
            public bool HasTangent =>
                // what is this abomination??
                UpperHull.Count > 0 ? UpperHull[0].hasTangent :
                LowerHull.Count > 0 && LowerHull[0].hasTangent;
